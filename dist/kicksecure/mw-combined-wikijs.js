/* === mw-combine.php : This file is autogenerated with "wikijs" from MediaWiki:Build.json ================================================== */
...
if( mwDev.data.log.jsload['MediaWiki:JsPerformanceTests.js'] !== false ) {
...
mwDev.data.log.jsload['MediaWiki:JsPerformanceTests.js'] = true;
...
/* === MediaWiki:DevTools.js ================================================== */





if( mwDev.data.log.jsload['MediaWiki:DevTools.js'] !== false ) {
...
mwDev.data.log.jsload['MediaWiki:DevTools.js'] = true;
...
if( mwDev.data.log.jsload['MediaWiki:BackToTopButton.js'] !== false ) {
...
mwDev.data.log.jsload['MediaWiki:BackToTopButton.js'] = true;
...
if( mwDev.data.log.jsload['MediaWiki:PayViaPaypal.js'] !== false ) {
...
mwDev.data.log.jsload['MediaWiki:PayViaPaypal.js'] = true;
...
if( mwDev.data.log.jsload['MediaWiki:Download_Button.js'] !== false ) {
...
mwDev.data.log.jsload['MediaWiki:Download_Button.js'] = true;
...
if( mwDev.data.log.jsload['MediaWiki:ExpandAndCollapse.js'] !== false ) {
...
mwDev.data.log.jsload['MediaWiki:ExpandAndCollapse.js'] = true;
...
/* === MediaWiki:WikitableAutoWrapper.js ================================================== */





if( mwDev.data.log.jsload['MediaWiki:WikitableAutoWrapper.js'] !== false ) {
...
mwDev.data.log.jsload['MediaWiki:WikitableAutoWrapper.js'] = true;
...
if( mwDev.data.log.jsload['MediaWiki:FlyInNotification.js'] !== false ) {
...
mwDev.data.log.jsload['MediaWiki:FlyInNotification.js'] = true;
...
if( mwDev.data.log.jsload['MediaWiki:TocLevelSwitcher.js'] !== false ) {
...
mwDev.data.log.jsload['MediaWiki:TocLevelSwitcher.js'] = true;
...
if( mwDev.data.log.jsload['MediaWiki:EditorFullscreen.js'] !== false ) {
...
mwDev.data.log.jsload['MediaWiki:EditorFullscreen.js'] = true;
...
if( mwDev.data.log.jsload['MediaWiki:EditorAutoBackup.js'] !== false ) {
...
mwDev.data.log.jsload['MediaWiki:EditorAutoBackup.js'] = true;
...
if( mwDev.data.log.jsload['MediaWiki:EditorMultiwikiNotice.js'] !== false ) {
...
mwDev.data.log.jsload['MediaWiki:EditorMultiwikiNotice.js'] = true;
...
/* === MediaWiki:StageServerNotice.js ================================================== */





if( mwDev.data.log.jsload['MediaWiki:StageServerNotice.js'] !== false ) {
...
mwDev.data.log.jsload['MediaWiki:StageServerNotice.js'] = true;
...
if( mwDev.data.log.jsload['MediaWiki:Footer.js'] !== false ) {
...
mwDev.data.log.jsload['MediaWiki:Footer.js'] = true;
...
if( mwDev.data.log.jsload['MediaWiki:Sitenotice.js'] !== false ) {
...
mwDev.data.log.jsload['MediaWiki:Sitenotice.js'] = true;
...
if( mwDev.data.log.jsload['MediaWiki:CodeSelectHighlightList.js'] !== false ) {
...
mwDev.data.log.jsload['MediaWiki:CodeSelectHighlightList.js'] = true;
...
/* === MediaWiki:HashController.js ================================================== */





if( mwDev.data.log.jsload['MediaWiki:HashController.js'] !== false ) {
...
mwDev.data.log.jsload['MediaWiki:HashController.js'] = true;
...
if( mwDev.data.log.jsload['MediaWiki:MiniModal.js'] !== false ) {
...
mwDev.data.log.jsload['MediaWiki:MiniModal.js'] = true;
...
if( mwDev.data.log.jsload['MediaWiki:TabContentController.js'] !== false ) {
...
mwDev.data.log.jsload['MediaWiki:TabContentController.js'] = true;
...
/* === MediaWiki:DiscoverHiddenElements.js ================================================== */





if( mwDev.data.log.jsload['MediaWiki:DiscoverHiddenElements.js'] !== false ) {
...
mwDev.data.log.jsload['MediaWiki:DiscoverHiddenElements.js'] = true;
...
if( mwDev.data.log.jsload['MediaWiki:CodeSelect.js'] !== false ) {
...
mwDev.data.log.jsload['MediaWiki:CodeSelect.js'] = true;
...
if( mwDev.data.log.jsload['MediaWiki:ShareTooltip.js'] !== false ) {
...
mwDev.data.log.jsload['MediaWiki:ShareTooltip.js'] = true;
...
if( mwDev.data.log.jsload['MediaWiki:DebugViaUrlModal.js'] !== false ) {
...
mwDev.data.log.jsload['MediaWiki:DebugViaUrlModal.js'] = true;
...
if( mwDev.data.log.jsload['MediaWiki:EnhanceHeadlines.js'] !== false ) {
...
mwDev.data.log.jsload['MediaWiki:EnhanceHeadlines.js'] = true;
...
if( mwDev.data.log.jsload['MediaWiki:EditorSaveAndContinue.js'] !== false ) {
...
mwDev.data.log.jsload['MediaWiki:EditorSaveAndContinue.js'] = true;
...
if( mwDev.data.log.jsload['MediaWiki:SearchModal.js'] !== false ) {
...
mwDev.data.log.jsload['MediaWiki:SearchModal.js'] = true;
...
if( mwDev.data.log.jsload['MediaWiki:Header.js'] !== false ) {
...
mwDev.data.log.jsload['MediaWiki:Header.js'] = true;
...
if( mwDev.data.log.jsload['MediaWiki:Pages.js'] !== false ) {
...
mwDev.data.log.jsload['MediaWiki:Pages.js'] = true;
...
/* === MediaWiki:LocalPages.js ================================================== */





if( mwDev.data.log.jsload['MediaWiki:LocalPages.js'] !== false ) {
...
mwDev.data.log.jsload['MediaWiki:LocalPages.js'] = true;
